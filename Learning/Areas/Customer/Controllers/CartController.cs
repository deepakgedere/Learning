...
namespace LearningWeb.Areas.Customer.Controllers
{
	[Area("Customer")]
	[Authorize]
	public class CartController : Controller
	{
		...
		public IActionResult Index()
		{
			...
			ShoppingCartVM = new()
			{
				ShoppingCartList = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUser.Id == userId,
		...
		public IActionResult SummaryPOST()
		{
			...
			ShoppingCartVM.ShoppingCartList = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUser.Id == userId,
				includeProperties: "Product");
			...
			if (applicationUser.CompanyId.GetValueOrDefault() == 0)
			{
				...
				foreach(var item in ShoppingCartVM.ShoppingCartList)
				{
					var sessionLineItem = new SessionLineItemOptions
					{
						...
						{
							UnitAmount = (long)(item.Price * 100), //$20.25 = 2050 
							Currency = "usd",
